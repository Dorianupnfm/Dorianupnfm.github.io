<?php
    ...
    if (isset($_GET['id'])){
	   ...
	   updateTransactions($id_transaction,$id_expence,1,0);
	   updateAccount($id_account,1,$amount,0);
	   deleteTransactions($id_transaction);

            if ($delete1=mysqli_query($con,"DELETE FROM expenses WHERE id='".$id_expence."'")){
            ?>
                        ...
                        <td class="text-right">
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="#" onclick="obtener_datos('<?php echo $id;?>');" data-toggle="modal" data-target=".bs-example-modal-lg-udp"><i class="fa fa-pencil m-r-5"></i> Editar</a>
