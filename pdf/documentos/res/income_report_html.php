    ...
    <table cellspacing="0" style="width: 100%;">
		...
		<?php } //end foreach ?>   
            <td style="width: 75%;text-align:right">
                <h2 style="color: #5c66bf;">Reporte de Ingresos</h2>
            </td>
        </tr>
    </table>
    <br>
      ...
      $sTable="income";
			...
			while ($key=mysqli_fetch_array($query)) {
                ...
                $amount=$key['amount'];
				 ...
				 $category=mysqli_query($con, "select * from category_income where id=$category_id");
				 ...
				 ?>
			<tr>
				<td style="width: 15%; text-align: left"><?php echo date("d/m/Y", strtotime($key['created_at'])); ?></td>
                <td style="width: 15%; text-align: left;"><?php echo $account_name ?></td>
                <td style="width: 15%; text-align: center"><?php echo $category_name; ?></td>
				<td style="width: 40%; text-align: left;"><?php echo $key['description']; ?></td>
       ...
       ?>
		...
		<tr>
            <td style='text-align:right; border-top:solid 1px #5c66bf;'></td>
             <td style='text-align:right; border-top:solid 1px #5c66bf;'></td>
			<td style='text-align:right; border-top:solid 1px #5c66bf;' colspan=2><strong>TOTAL <?php echo $coin_c;?></strong> </td>
