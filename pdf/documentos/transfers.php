<?php
	...
	$sql_count=mysqli_query($con,"select * from accounts_transfers where user_id='".$session_id."'");
    ...
    // get the HTML
     ob_start();
     include(dirname('__FILE__').'/res/transfers_html.php');
